...
const SelectTrigger = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Trigger>, { error?: string; context?: string } & React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger>>(
