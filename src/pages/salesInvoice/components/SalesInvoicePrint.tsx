...
interface ISalesInvoicePrint {
  customerName: string;
  salesmanName: string;
  invoiceDate: string;
  totalAmount: string;
  items: { name: string; qty: string; price: string; unit: string }[];
}

export const SalesInvoicePrint = (props: ISalesInvoicePrint) => {
  return (
    <Document>
      <Page size="A4" style={{ padding: 10 }}>
        ...
        <View style={{ marginTop: 20 }}>
          <View style={{ ...rowStyles, justifyContent: "flex-start" }}>
            <Text style={{ fontFamily: LIGHT_FONT, fontSize: SMALL_TEXT, width: 140 }}>Customer Name: </Text>
            <Text style={{ fontFamily: BOLD_FONT, fontSize: SMALL_TEXT }}>{props.customerName}</Text>
          </View>
          <View style={{ ...rowStyles, justifyContent: "flex-start" }}>
            <Text style={{ fontFamily: LIGHT_FONT, fontSize: SMALL_TEXT, width: 140 }}>Salesman Name: </Text>
            <Text style={{ fontFamily: BOLD_FONT, fontSize: SMALL_TEXT }}>{props.salesmanName}</Text>
          </View>
          <View style={{ ...rowStyles, justifyContent: "flex-start" }}>
        ...
        <View style={{ marginTop: 30 }}>
          <View style={{ border: "1px solid #000", display: "flex", flexDirection: "row", alignItems: "center", padding: "5px", columnGap: 20 }}>
            ...
            <View style={{ width: 90 }}>
              <Text style={{ fontFamily: LIGHT_FONT, fontSize: SMALL_TEXT }}>Unit</Text>
            </View>
          ...
          <View>
            {props.items?.map((item, i) => (
              <View style={{ borderBottom: "1px solid #000", display: "flex", flexDirection: "row", alignItems: "center", padding: "5px", columnGap: 20 }}>
                ...
                <View style={{ width: 90 }}>
                  <Text style={{ fontFamily: LIGHT_FONT, fontSize: SMALL_TEXT }}>{item.unit}</Text>
                </View>
                <View style={{ width: 120 }}>
        ...
        <View style={{ marginTop: "auto", display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          <Text style={{ fontFamily: LIGHT_FONT, fontSize: SMALL_TEXT }}>Sales Invoice</Text>
