...
import { DotsVerticalIcon, EyeOpenIcon, PlusIcon } from "@radix-ui/react-icons";
...
const PurchaseInvoiceTable = (props: PageProps) => {
  const { menu } = props;
  const { data: invoices } = useQuery(["purchaseInvoices"], purchaseInvoiceApi.getAllSalesInvoices);
  ...
  const table = useReactTable({
    data: invoices?.responseData.invoices || [],
    columns: [
      ...columns,
      {
        id: "actions",
